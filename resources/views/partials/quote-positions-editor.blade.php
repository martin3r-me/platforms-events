@php
    ...
    /**
     * Zeilen-Typen über den Wert in "gruppe":
     *  - Headline      → grüner Hintergrund, bold Bezeichnung, kein Preis
     *  - Speisentexte  → gelber Hintergrund, kursiv Bezeichnung
     *  - Trenntext     → neutraler Trenner
     */
