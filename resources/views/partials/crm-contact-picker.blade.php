...
{{--
    CRM-Kontakt-Picker fuer Ansprechpartner einer Firma.
    Nutzt CrmCompanyContactsProviderInterface::contacts(companyId) — Liste ist
    bereits auf die aktuelle Firma gefiltert, daher client-seitige Filterung in Alpine.
    Props:
      - slot          → Kontakt-Slot-Key ('organizer', 'organizer_onsite', 'invoice', 'delivery')
      - contacts      → [{id, name, email, position, is_primary}, ...]
      - hasCompany    → Wenn false, zeigt der Picker Fallback-Input + Hinweis
--}}
