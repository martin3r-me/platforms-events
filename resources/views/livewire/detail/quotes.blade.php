        ...
        <div class="space-y-4">
                        ...
                        <tbody>
                            @foreach($positions as $p)
                                <tr class="border-b border-[var(--ui-border)]/60">
                                    ...
                                    <td class="px-2 py-1 text-xs font-mono text-right">{{ $fmt($p->preis) }}</td>
            ...
            <div class="bg-slate-50 rounded-md p-3 space-y-2">
                ...
                <div class="grid grid-cols-8 gap-2">
                    ...
                    <input wire:model="newPosition.preis" type="number" step="0.01" placeholder="Preis" class="border border-slate-200 rounded-md px-2 py-1.5 text-xs font-mono">
