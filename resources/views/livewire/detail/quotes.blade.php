<div class="space-y-4 max-w-[960px]">
    ...
    @if($activeItem)
        <div id="positions-editor"
             ...
             class="mt-5 bg-white border-2 border-blue-400 rounded-xl overflow-hidden shadow-sm">
            <div class="flex items-center justify-between px-4 py-3 bg-blue-50 border-b border-blue-200">
                <div class="flex items-center gap-2.5">
                    ...
                    <h3 class="text-[0.8rem] font-bold text-[var(--ui-secondary)]">Positionen · {{ $activeItem->typ }}</h3>
