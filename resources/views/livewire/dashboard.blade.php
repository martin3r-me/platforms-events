<x-ui-page>
    ...
    <x-ui-page-container>
        <div class="space-y-6">
            {{-- Welcome Section --}}
            <x-ui-panel title="Willkommen im Events Modul" subtitle="Plane und verwalte deine Events">
                <div class="p-6 text-center">
                    ...
                    <p class="text-[var(--ui-muted)]">
                        Plane und verwalte deine Events.
                    </p>
                </div>
            </x-ui-panel>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="p-3 bg-[var(--ui-muted-5)] rounded-lg border border-[var(--ui-border)]/40">
                            <div class="text-xs text-[var(--ui-muted)]">Events</div>
