    ...
    public static function catalog(): array
    {
        return [
            'variables' => [
                ...
                'item.sum_gesamt'      => 'Roh-Summe aller Position-Gesamt-Werte (ohne Netto-Umrechnung)',
                'item.count'           => 'Anzahl Positionen im Vorgang',
                'item.sum_anz'         => 'Summe aller Anzahlen (pos.anz) aller Positionen',
                'item.price_mode'      => "'netto' | 'brutto'",
                'item.sum_by_gruppe'   => "Wert-Summen pro Gruppe: sum_by_gruppe['Bier']",
                'item.count_by_gruppe' => "Positionsanzahl pro Gruppe: count_by_gruppe['Bier']",
                'item.anz_by_gruppe'   => "Summierte Stueckzahlen pro Gruppe: anz_by_gruppe['Bier']",
                'item.ek_by_gruppe'    => "EK-Summen pro Gruppe: ek_by_gruppe['Bier']",
