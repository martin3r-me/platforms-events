...
class ContractRenderer
{
    ...
    protected static function buildValueMap(Event $event, ?Contract $contract): array
    {
        ...
        return [
            ...
            '{DELIVERY_COMPANY}'  => (string) ($event->deliveryLocation?->name ?? self::companyName($event->delivery_address, $event->delivery_address_crm_company_id)),
            '{DELIVERY_CONTACT}'  => (string) ($event->delivery_note ?? ''),
