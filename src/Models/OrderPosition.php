...
/**
 * @ai.description Einzelne Bestell-Position innerhalb eines OrderItem (Gruppe/Name/Anzahl/Uhrzeit/Preise/MwSt/Bemerkung).
 */
class OrderPosition extends Model
{
    use SoftDeletes;

    protected $table = 'events_order_positionen';
