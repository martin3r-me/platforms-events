...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('events_quote_items')) {
            Schema::create('events_quote_items', function (Blueprint $table) {
                $table->id();
                ...
                $table->decimal('umsatz', 10, 2)->default(0);
                $table->string('mwst', 20)->default('19%');
    ...
    {
        Schema::dropIfExists('events_quote_items');
    }
};
