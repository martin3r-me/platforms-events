...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('events_flat_rate_rules')) {
        ...
        if (!Schema::hasTable('events_flat_rate_applications')) {
            Schema::create('events_flat_rate_applications', function (Blueprint $table) {
                ...
                $table->foreignId('quote_position_id')->nullable()->constrained('events_quote_positions')->nullOnDelete();
